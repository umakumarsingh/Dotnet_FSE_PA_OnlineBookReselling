...
namespace OnlineBookReselling
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IAdminBookResellingRepository, AdminBookResellingRepository>();
            services.AddScoped<IAdminBookResellingServices, AdminBookResellingServices>();
            services.AddScoped<IBookResellingRepository, BookResellingRepository>();
            services.AddScoped<IBookResellingServices, BookResellingServices>();
